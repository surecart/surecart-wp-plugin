...
class PayoutsRestServiceProviderTest extends SureCartUnitTestCase
{
	...
	public function requestProvider()
	{
		return [
			...
			'Edit: Unauthenticated' => [null, 'PATCH', '/surecart/v1/payouts/test', 401],
			'Edit: Missing Capability' => [[], 'PATCH', '/surecart/v1/payouts/test', 403],
			'Edit: Has Capability' => [['edit_sc_affiliates'], 'PATCH', '/surecart/v1/payouts/test', 200],
