...
use SureCart\Rest\ClicksRestServiceProvider;
use SureCart\Support\Errors\ErrorsServiceProvider;
use SureCart\Tests\SureCartUnitTestCase;

class ClicksRestServiceProviderTest extends SureCartUnitTestCase
{
	...
	public function setUp() : void
	{
		...
		\SureCart::make()->bootstrap([
			'providers' => [
				...
				ClicksRestServiceProvider::class,
	...
	{
		return [
			'List: Unauthenticated' => [null, 'GET', '/surecart/v1/clicks', 401],
			'List: Missing Capability' => [[], 'GET', '/surecart/v1/clicks', 403],
			'List: Has Capability' => [['read_sc_affiliates'],'GET', '/surecart/v1/clicks', 200],
