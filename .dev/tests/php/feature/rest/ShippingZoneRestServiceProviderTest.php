...
use SureCart\Rest\ShippingZoneRestServiceProvider;
...
class ShippingZoneRestServiceProviderTest extends SureCartUnitTestCase
{
    ...
    public function setUp() : void
    {
        ...
        \SureCart::make()->bootstrap([
            'providers' => [
                ...
                ShippingZoneRestServiceProvider::class,
    ...
    public function requestProvider()
    {
        ...
        return [
			...
			'Edit: Unauthenticated' => [null, 'PATCH', '/surecart/v1/shipping_zones/test', 401],
            'Edit: Missing Capability' => [[], 'PATCH', '/surecart/v1/shipping_zones/test', 403],
            'Edit: Has Capability' => [['manage_sc_shop_settings'], 'PATCH', '/surecart/v1/shipping_zones/test', 200],
			'Delete: Unauthenticated' => [null, 'DELETE', '/surecart/v1/shipping_zones/test', 401],
            'Delete: Missing Capability' => [[], 'DELETE', '/surecart/v1/shipping_zones/test', 403],
            'Delete: Has Capability' => [['manage_sc_shop_settings'], 'DELETE', '/surecart/v1/shipping_zones/test', 200],
			'Create: Unauthenticated' => [null, 'POST', '/surecart/v1/shipping_zones', 401],
            'Create: Missing Capability' => [[], 'POST', '/surecart/v1/shipping_zones', 403],
            'Create: Has Capability' => [['manage_sc_shop_settings'], 'POST', '/surecart/v1/shipping_zones', 200],
        ];
    }
