...
class ShippingRateRestServiceProviderTest extends SureCartUnitTestCase
{
    ...
    public function requestProvider()
    {
        ...
        return [
            ...
            'List: Has Capability' => [['manage_sc_shop_settings', '/surecart/v1/shipping_methods', 200]],
			...
			'Delete: Unauthenticated' => [null, 'DELETE', '/surecart/v1/shipping_methods/test', 404],
            'Delete: Missing Capability' => [[], 'DELETE', '/surecart/v1/shipping_methods/test', 404],
            'Delete: Has Capability' => [['manage_sc_shop_settings'], 'DELETE', '/surecart/v1/shipping_methods/test', 404],
