...
class ProductListMigrationServiceTest extends SureCartUnitTestCase {
	...
	public function test_render_product_template()
	{
		...
		$this->assertStringContainsString('<!-- wp:surecart/product-template {"limit":10,"columns":3,"search_enabled":true,"pagination_enabled":true,"sort_enabled":true,"collection_enabled":true,"style":{"spacing":{"blockGap":"30px"}},"layout":{"type":"grid","columnCount":3}} --><!-- wp:group {"style":{"spacing":{"blockGap":"5px"}},"layout":{"type":"flex","orientation":"vertical","justifyContent":"stretch"}} --><div class="wp-block-group " style=""><!-- wp:cover {"useFeaturedImage":true,"dimRatio":0,"isUserOverlayColor":true,"focalPoint":{"x":0.5,"y":0.5},"contentPosition":"top right","isDark":false,"style":{"dimensions":{"aspectRatio":"3\/4"},"layout":{"selfStretch":"fit","flexSize":null},"spacing":{"margin":{"bottom":"15px"}},"border":{"radius":"10px"}},"key1":"value1"} --><div class="wp-block-cover is-light has-custom-content-position is-position-top-right" style="border-radius:10px;margin-bottom:15px"><span aria-hidden="true" class="wp-block-cover__background has-background-dim-0 has-background-dim"></span><div class="wp-block-cover__inner-container"></div></div><!-- /wp:cover --><!-- wp:surecart/product-title {"key2":"value2","level":0} /--><!-- wp:group {"style":{"spacing":{"blockGap":"0.5em","margin":{"top":"0px","bottom":"0px"}},"margin":{"top":"0px","bottom":"0px"}},"layout":{"type":"flex","flexWrap":"nowrap"}} --><div class="wp-block-group"><!-- wp:surecart/product-list-price {"key3":"value3"} /--><!-- wp:surecart/product-list-price-sale {"key3":"value3"} /--></div><!-- /wp:group --></div><!-- /wp:group --><!-- /wp:surecart/product-template -->', $this->service->block_html);
		$this->assertStringContainsString('<!-- wp:cover {"useFeaturedImage":true,"dimRatio":0,"isUserOverlayColor":true,"focalPoint":{"x":0.5,"y":0.5},"contentPosition":"top right","isDark":false,"style":{"dimensions":{"aspectRatio":"3\/4"},"layout":{"selfStretch":"fit","flexSize":null},"spacing":{"margin":{"bottom":"15px"}},"border":{"radius":"10px"}},"key1":"value1"} -->', $this->service->block_html);
		$this->assertStringContainsString('<!-- wp:surecart/product-title {"key2":"value2","level":0} /-->', $this->service->block_html);
		$this->assertStringContainsString('<!-- wp:surecart/product-list-price {"key3":"value3"} /-->', $this->service->block_html);
	...
	public function test_render_sort_and_filter_does_not_render_if_sort_disabled()
	{
		...
		$this->service->renderSortAndFilter();
		$this->assertStringContainsString('<!-- wp:group {"layout":{"type":"flex","flexWrap":"nowrap"}} --><div class="wp-block-group"></div><!-- /wp:group -->', $this->service->block_html);
	}
	...
	public function test_product_list_with_all_attrs_and_styles_applied()
	{
		...
		$this->service->renderProductTemplate();
		$this->assertStringContainsString('<!-- wp:surecart/product-template {"limit":5,"type":"custom","ids":["b0bb8d48-7bba-4d6f-ac58-7b801d1471fb","6730d1ca-871c-4f55-90ad-923fd81bff6a","585504de-74ac-48b9-9c62-563b86cd8ed3","a029510f-7aed-451f-8a49-357d11b2b450"],"style":{"spacing":{"blockGap":"30px"}},"layout":{"type":"grid","columnCount":3}} --><!-- wp:group {"style":{"spacing":{"blockGap":"5px"}},"layout":{"type":"flex","orientation":"vertical","justifyContent":"stretch"}} --><div class="wp-block-group has-background has-accent-3-background-color has-border-color has-accent-4-border-color" style="background-color:var(--wp--preset--color--accent-3);border-radius:20px;border-width:12px;padding-top:var(--wp--preset--spacing--10);padding-bottom:var(--wp--preset--spacing--10);padding-left:var(--wp--preset--spacing--10);padding-right:var(--wp--preset--spacing--10);margin-top:var(--wp--preset--spacing--10);margin-bottom:var(--wp--preset--spacing--10);margin-left:var(--wp--preset--spacing--10);margin-right:var(--wp--preset--spacing--10);"><!-- wp:cover {"useFeaturedImage":true,"dimRatio":0,"isUserOverlayColor":true,"focalPoint":{"x":0.5,"y":0.5},"contentPosition":"top right","isDark":false,"style":{"border":{"radius":"6px","width":"6px"},"spacing":{"padding":{"top":"var:preset|spacing|10","bottom":"var:preset|spacing|10","left":"var:preset|spacing|10","right":"var:preset|spacing|10"},"margin":{"top":"var:preset|spacing|10","bottom":"var:preset|spacing|10","left":"var:preset|spacing|10","right":"var:preset|spacing|10"}}},"sizing":"cover","ratio":"1\/1.33","borderColor":"base-2"} --><div class="wp-block-cover is-light has-custom-content-position is-position-top-right" style="border-radius:10px;margin-bottom:15px"><span aria-hidden="true" class="wp-block-cover__background has-background-dim-0 has-background-dim"></span><div class="wp-block-cover__inner-container"></div></div><!-- /wp:cover --><!-- wp:group {"style":{"spacing":{"blockGap":"0.5em","margin":{"top":"0px","bottom":"0px"}},"margin":{"top":"0px","bottom":"0px"}},"layout":{"type":"flex","flexWrap":"nowrap"}} --><div class="wp-block-group"><!-- wp:surecart/product-list-price {"style":{"spacing":{"padding":{"top":"6px"},"margin":{"top":"var:preset|spacing|10","bottom":"var:preset|spacing|10"}},"color":{"text":"#ffea00"},"typography":{"fontSize":"20px"}}} /--><!-- wp:surecart/product-list-price-sale {"style":{"spacing":{"padding":{"top":"6px"},"margin":{"top":"var:preset|spacing|10","bottom":"var:preset|spacing|10"}},"color":{"text":"#ffea00"},"typography":{"fontSize":"20px"}}} /--></div><!-- /wp:group --><!-- wp:surecart/product-title {"title":"Product Title","textColor":"base","fontSize":"x-small","style":{"typography":{"fontWeight":"500"},"spacing":{"padding":{"top":"10px"},"margin":{"top":"var:preset|spacing|10","bottom":"var:preset|spacing|10"}}},"level":0} /--></div><!-- /wp:group --><!-- /wp:surecart/product-template -->', $this->service->block_html);
