# <a href="http://wpemerge.com"><img src="https://docs.wpemerge.com/_images/wpemerge-plugin-logo-bar.png" height="61" alt="Checkout Engine Logo" aria-label='WPEmerge.com' /></a>
...
_This is the Checkout Engine project - for the WP Emerge framework please check out https://github.com/htmlburger/wpemerge._
...
- Autoloading for all classes in your `CheckoutEngine\` namespace.
...
Checkout Engine is completely open source and we encourage everybody to participate by:
