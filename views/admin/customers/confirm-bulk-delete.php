		...
		<sc-card style="--sc-card-padding: var(--sc-spacing-xxx-large)">
			<form action="" method="post">
				...
				<sc-flex flex-direction="column" style="--sc-flex-column-gap:1em;">
					...
					<sc-text>
						<?php echo esc_html( _n( 'Are you sure you want to permanently delete this customer? All associated subscriptions, payments, and purchases will also be deleted within a day. This cannot be undone.', 'Are you sure you want to permanently delete these customers? All associated subscriptions, payments, and purchases will also be deleted within a day. This cannot be undone.', count( $customers ), 'surecart' ) ); ?>
					</sc-text>

					<ul class="sc-customer-list">
						<?php foreach ( $customers as $customer ) : ?>
							<li>
								<a href="<?php echo esc_url( \SureCart::getUrl()->edit( 'customers', $customer->id ) ); ?>" target="_blank">
