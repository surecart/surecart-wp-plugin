						...
						<sc-flex flex-direction="column" gap="1em">
							...
							<div>
								<?php if ( ! empty( $processors->stripe_live ) && ! empty( $processors->stripe_test ) ) : ?>
									<sc-tag type="success"><?php esc_html_e( 'Test and Live Payments Enabled', 'surecart' ); ?></sc-tag>
								<?php else : ?>
									<?php if ( ! empty( $processors->stripe_live ) ) : ?>
										<sc-tag type="success"><?php esc_html_e( 'Live Payments Enabled', 'surecart' ); ?></sc-tag>
										<sc-tag type="warning"><?php esc_html_e( 'Test Payment Not Enabled', 'surecart' ); ?></sc-tag>
									<?php endif; ?>
									<?php if ( ! empty( $processors->stripe_test ) ) : ?>
										<sc-tag type="success"><?php esc_html_e( 'Test Payments Enabled', 'surecart' ); ?></sc-tag>
										<sc-tag type="warning"><?php esc_html_e( 'Live Payments Not Enabled', 'surecart' ); ?></sc-tag>
									<?php endif; ?>
								<?php endif; ?>
							</div>
						</sc-flex>
					...
					<sc-stacked-list-row href="<?php echo esc_url( trailingslashit( SURECART_APP_URL ) . 'processors' ); ?>" target="_blank">
						...
						<sc-flex flex-direction="column" gap="1em">
							...
							<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="124px" height="33px" viewBox="0 0 124 33" enable-background="new 0 0 124 33" xml:space="preserve">
								...
								<div>
									<?php if ( ! empty( $processors->paypal_live ) && ! empty( $processors->paypal_test ) ) : ?>
										<sc-tag type="success"><?php esc_html_e( 'Test and Live Payments Enabled', 'surecart' ); ?></sc-tag>
									<?php else : ?>
