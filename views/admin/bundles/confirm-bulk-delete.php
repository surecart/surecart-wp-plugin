		...
		<sc-card style="--sc-card-padding: var(--sc-spacing-xxx-large)">
			<form action="" method="post">
				...
				<sc-flex flex-direction="column" style="--sc-flex-column-gap:1em;">
					...
					<sc-heading size="large"><?php esc_html_e( 'Delete Bundles', 'surecart' ); ?></sc-heading>

					<sc-text>
						<?php echo esc_html( _n( 'Are you sure you want to permanently delete this bundle? This cannot be undone.', 'Are you sure you want to permanently delete these bundles? This cannot be undone.', count( $bundles ), 'surecart' ) ); ?>
					</sc-text>

					<ul class="sc-product-list">
						<?php foreach ( $bundles as $bundle ) : ?>
							<li>
								<a href="<?php echo esc_url( \SureCart::getUrl()->edit( 'bundle', $bundle->id ) ); ?>" target="_blank">
									<?php echo wp_kses_post( $bundle->name ); ?>
