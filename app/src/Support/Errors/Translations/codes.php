...
return array(
	...
	'customer.shipping_address.postal_code.invalid_format' => __( 'This postal code does not match the format required for the selected country. Please enter a valid postal code for shipping.', 'surecart' ),
	'customer.billing_address.postal_code.invalid_format'  => __( 'This postal code does not match the format required for the selected country. Please enter a valid postal code for billing.', 'surecart' ),
	...
	'customer_notification_protocol.abandoned_checkout_enabled.invalid_address' => __( 'You cannot enable abandoned checkouts until you have updated your business contact address. Please add an address to your store settings.', 'surecart' ),
	'abandoned_checkout_protocol.enabled.invalid_brand_address' => __( 'Notification Settings cannot be enabled until you set an address in your store settings.', 'surecart' ),
	...
	'verification_code.email.blocked_duplicate'            => __( 'A code was recently sent to you. Please wait before requesting another.', 'surecart' ),
	...
	'product.bundle_items.component_product_id.taken'      => __( 'This product is already in the bundle. Increase its quantity instead of adding it twice.', 'surecart' ),
	'product.bundle_items.component_product.cannot_be_bundle' => __( "You can't nest bundles. Pick a non-bundle product as a component.", 'surecart' ),
	'product.bundle_items.component_product.blank'         => __( 'Please pick a component product before saving.', 'surecart' ),
	'product.bundle.immutable_after_create'                => __( "A product's bundle setting can't be changed after creation. Create a new bundle product instead.", 'surecart' ),
	'product.in_use_as_bundle_component'                   => __( 'This product is included in one or more bundles. Remove it from those bundles before archiving.', 'surecart' ),
