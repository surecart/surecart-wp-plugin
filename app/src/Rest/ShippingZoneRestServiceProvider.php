...
use SureCart\Controllers\Rest\ShippingZoneController;
use SureCart\Rest\RestServiceInterface;

/**
 * Service provider for Shipping Zone Rest Requests
 */
class ShippingZoneRestServiceProvider extends RestServiceProvider implements RestServiceInterface {
	/**
	 * Endpoint.
	 *
	 * @var string
	 */
	protected $endpoint = 'shipping_zones';
	 ...
	 * @var string
	 */
	protected $controller = ShippingZoneController::class;
