...
/**
 * Service provider for Affiliation Rest Requests
 */
class AffiliationRestServiceProvider extends RestServiceProvider implements RestServiceInterface {
	/**
	 * Endpoint.
	 *
	 * @var string
		...
		register_rest_route(
			...
			[
				[
					...
					'permission_callback' => [ $this, 'deactivate_permissions_check' ],
				],
				// Register our schema callback.
				'schema' => [ $this, 'get_item_schema' ],
			]
