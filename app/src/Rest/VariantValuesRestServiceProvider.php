...
/**
 * Service provider for Variant Values Rest Requests
 */
class VariantValuesRestServiceProvider extends RestServiceProvider implements RestServiceInterface {
	/**
	 * Endpoint.
	 *
	 * @var string
	 ...
	 * @var string
	 */
	protected $controller = VariantValuesController::class;
	...
	public function get_item_permissions_check( $request ) {
		if ( 'edit' === $request['context'] && ! current_user_can( 'edit_sc_prices' ) ) {
			return new \WP_Error(
				...
				__( 'Sorry, you are not allowed to edit variant values.', 'surecart' ),
