	...
	public function get_item_schema() {
		...
		$this->schema = [
			...
			'properties' => [
				...
				'filters'     => [
					'description' => esc_html__( 'The conditions that will filter this upsell to be recommeneded. Accepted keys are price_ids, product_ids, and product_group_ids with array values.', 'surecart' ),
					'type'        => 'string',
					'context'     => [ 'view', 'edit' ],
				],
				'name'        => [
