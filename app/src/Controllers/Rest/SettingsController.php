...
class SettingsController {
	...
	public function find( \WP_REST_Request $request ) {
		return rest_ensure_response(
			[
				...
				'load_blocks_style_on_demand' => (bool) get_option( 'surecart_load_blocks_style_on_demand', false ),
			]
		);
	}
	...
	public function edit( \WP_REST_Request $request ) {
		...
		if ( isset( $request['load_blocks_style_on_demand'] ) ) {
			update_option( 'surecart_load_blocks_style_on_demand', $request->get_param( 'load_blocks_style_on_demand' ) );
		}
