...
class BuyPageController extends ProductTypePageController {
	...
	public function show( $request, $view, $id ) {
		...
		$this->product = \SureCart\Models\Product::with( [ 'image', 'prices', 'product_medias', 'product_media.media', 'variants', 'variants.variant_values', 'variant_options', 'variant_options.variant_values' ] )->find( $id );
