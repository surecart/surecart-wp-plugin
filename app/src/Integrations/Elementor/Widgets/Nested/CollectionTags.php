 ...
 */
class CollectionTags extends \Elementor\Modules\NestedElements\Base\Widget_Nested_Base {
	/**
	 * Get the widget name.
	 *
	 * @return string
	...
	public function get_title() {
		return esc_html__( 'Collection Tags', 'elementor' );
	}
	...
	public function get_keywords() {
		return [ 'collection', 'tags', 'surecart' ];
	}
	...
	public function get_script_depends() {
		return [ 'surecart-elementor-collection-tags' ];
	}
	...
	protected function get_default_children_container_placeholder_selector() {
		return '.en-collection-tags-item';
	}
		...
		if ( \Elementor\Plugin::$instance->experiments->is_feature_active( 'e_nested_atomic_repeaters' ) ) {
			return array_merge(
				...
				[
					...
					'target_container'           => [ '.en-collection-tags' ],
					'node'                       => 'details',
					'is_interlaced'              => true,
				]
			);
	...
	protected function content_template_single_repeater_item() {
		?>
		<span class="en-collection-tags-item-tag">Tag 1</span>
		<span class="en-collection-tags-item-tag">Tag 2</span>
		<span class="en-collection-tags-item-tag">Tag 3</span>
		<?php
	}
	...
	protected function content_template() {
		?>
		<div class="en-collection-tags">
			<div class="en-collection-tags-item">
				<span class="en-collection-tags-item-tag">Tag 1</span>
				<span class="en-collection-tags-item-tag">Tag 2</span>
				<span class="en-collection-tags-item-tag">Tag 3</span>
			</div>
