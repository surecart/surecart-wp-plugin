...
class AccountService {
	...
	protected function fetchAccount() {
		$this->account = Account::with( array( 'brand', 'brand.address', 'customer_portal_protocol', 'tax_protocol', 'tax_protocol.address', 'review_protocol', 'subscription_protocol', 'shipping_protocol', 'affiliation_protocol' ) )->find();
		return $this->account;
	}
