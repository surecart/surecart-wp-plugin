...
class AdminMenuPageService {
	...
	public function registerAdminPages() {
		...
		$this->pages = [
			...
			'checkouts'          => in_array( $_GET['page'] ?? '', [ 'sc-orders', 'sc-checkouts' ] ) ? \add_submenu_page( $this->slug, __( 'Checkouts', 'surecart' ), '↳ ' . __( 'Add New', 'surecart' ), 'edit_sc_orders', 'sc-checkouts', '__return_false' ): null,
