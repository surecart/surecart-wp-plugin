...
class AdminMenuPageService {
	...
	public function registerAdminPages() {
		...
		$this->pages = [
			...
			'cancellations'   => in_array( $_GET['page'] ?? '', [ 'sc-subscriptions', 'sc-subscription-cancellations' ] ) ? \add_submenu_page( $this->slug, __( 'Subscription Cancellations', 'surecart' ), '↳ ' . __( 'Cancellations', 'surecart' ), 'edit_sc_subscriptions', 'sc-subscription-cancellations', '__return_false' ) : null,
