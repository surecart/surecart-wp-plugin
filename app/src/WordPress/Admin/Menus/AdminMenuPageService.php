...
class AdminMenuPageService {
	...
	public function registerAdminPages() {
		...
		$this->pages = [
			...
			'product-collections' => in_array( $_GET['page'] ?? '', [ 'sc-products', 'sc-product-collections' ] ) ? \add_submenu_page( $this->slug, __( 'Collections', 'surecart' ), '↳ ' . __( 'Collections', 'surecart' ), 'edit_sc_products', 'sc-product-collections', '__return_false' ) : null,
