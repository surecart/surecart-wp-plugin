...
class AdminMenuPageService {
	...
	public function registerAdminPages() {
		...
		$this->pages = [
			...
			'affiliate-requests'  => in_array( $_GET['page'] ?? '', [ 'sc-affiliates', 'sc-affiliate-requests' ], true ) ? \add_submenu_page( $this->slug, __( 'Requests', 'surecart' ), '↳ ' . __( 'Requests', 'surecart' ), 'edit_sc_affiliates', 'sc-affiliate-requests', '__return_false' ) : null,
			'affiliate-clicks'  => in_array( $_GET['page'] ?? '', [ 'sc-affiliates', 'sc-affiliate-clicks' ], true ) ? \add_submenu_page( $this->slug, __( 'Clicks', 'surecart' ), '↳ ' . __( 'Clicks', 'surecart' ), 'edit_sc_affiliates', 'sc-affiliate-clicks', '__return_false' ) : null,
