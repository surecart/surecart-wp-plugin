...
class AdminMenuPageService {
	...
	public function registerAdminPages() {
		...
		$this->pages = [
			...
			'upsells'             => in_array( $_GET['page'] ?? '', [ 'sc-orders', 'sc-upsells', 'sc-checkouts' ], true ) ? \add_submenu_page( $this->slug, __( 'Upsells', 'surecart' ), '↳ ' . __( 'Upsells', 'surecart' ), 'edit_sc_orders', 'sc-upsells', '__return_false' ) : null,
