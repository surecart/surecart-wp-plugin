...
class PermalinkServiceProvider implements ServiceProviderInterface {
	...
	public function bootstrap( $container ) {
		...
		( new PermalinkService() )
			->params( array( 'sc_checkout_product_id' ) )
		...
		( new PermalinkService() )
			->params( array( 'sc_collection_page_id' ) )
		...
		( new PermalinkService() )
			->params( array( 'sc_checkout_change_mode', 'sc_checkout_post' ) )
