...
export const ScProductImageCarousel = /*@__PURE__*/createReactComponent<JSX.ScProductImageCarousel, HTMLScProductImageCarouselElement>('sc-product-image-carousel');
