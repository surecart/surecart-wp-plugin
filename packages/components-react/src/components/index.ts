...
export const ScProductPrices = /*@__PURE__*/createReactComponent<JSX.ScProductPrices, HTMLScProductPricesElement>('sc-product-prices');
export const ScProductText = /*@__PURE__*/createReactComponent<JSX.ScProductText, HTMLScProductTextElement>('sc-product-text');
export const ScProductTitle = /*@__PURE__*/createReactComponent<JSX.ScProductTitle, HTMLScProductTitleElement>('sc-product-title');
