...
export const ScAddressSuggestions = /*@__PURE__*/createReactComponent<JSX.ScAddressSuggestions, HTMLScAddressSuggestionsElement>('sc-address-suggestions');
...
export const ScCheckoutAutofillProvider = /*@__PURE__*/createReactComponent<JSX.ScCheckoutAutofillProvider, HTMLScCheckoutAutofillProviderElement>('sc-checkout-autofill-provider');
...
export const ScCheckoutGeoPermission = /*@__PURE__*/createReactComponent<JSX.ScCheckoutGeoPermission, HTMLScCheckoutGeoPermissionElement>('sc-checkout-geo-permission');
...
export const ScCheckoutProductBundleComponentVariants = /*@__PURE__*/createReactComponent<JSX.ScCheckoutProductBundleComponentVariants, HTMLScCheckoutProductBundleComponentVariantsElement>('sc-checkout-product-bundle-component-variants');
...
export const ScFeatureDemoBanner = /*@__PURE__*/createReactComponent<JSX.ScFeatureDemoBanner, HTMLScFeatureDemoBannerElement>('sc-feature-demo-banner');
...
export const ScInvoiceDetails = /*@__PURE__*/createReactComponent<JSX.ScInvoiceDetails, HTMLScInvoiceDetailsElement>('sc-invoice-details');
export const ScInvoiceMemo = /*@__PURE__*/createReactComponent<JSX.ScInvoiceMemo, HTMLScInvoiceMemoElement>('sc-invoice-memo');
export const ScInvoiceStatusBadge = /*@__PURE__*/createReactComponent<JSX.ScInvoiceStatusBadge, HTMLScInvoiceStatusBadgeElement>('sc-invoice-status-badge');
...
export const ScLineItemTrial = /*@__PURE__*/createReactComponent<JSX.ScLineItemTrial, HTMLScLineItemTrialElement>('sc-line-item-trial');
...
export const ScManualPaymentMethod = /*@__PURE__*/createReactComponent<JSX.ScManualPaymentMethod, HTMLScManualPaymentMethodElement>('sc-manual-payment-method');
...
export const ScPassword = /*@__PURE__*/createReactComponent<JSX.ScPassword, HTMLScPasswordElement>('sc-password');
...
export const ScProductBuyButton = /*@__PURE__*/createReactComponent<JSX.ScProductBuyButton, HTMLScProductBuyButtonElement>('sc-product-buy-button');
export const ScProductDonationAmountChoice = /*@__PURE__*/createReactComponent<JSX.ScProductDonationAmountChoice, HTMLScProductDonationAmountChoiceElement>('sc-product-donation-amount-choice');
export const ScProductDonationChoices = /*@__PURE__*/createReactComponent<JSX.ScProductDonationChoices, HTMLScProductDonationChoicesElement>('sc-product-donation-choices');
export const ScProductDonationCustomAmount = /*@__PURE__*/createReactComponent<JSX.ScProductDonationCustomAmount, HTMLScProductDonationCustomAmountElement>('sc-product-donation-custom-amount');
...
export const ScProductLineItemNote = /*@__PURE__*/createReactComponent<JSX.ScProductLineItemNote, HTMLScProductLineItemNoteElement>('sc-product-line-item-note');
export const ScProductPillsVariantOption = /*@__PURE__*/createReactComponent<JSX.ScProductPillsVariantOption, HTMLScProductPillsVariantOptionElement>('sc-product-pills-variant-option');
export const ScProductPrice = /*@__PURE__*/createReactComponent<JSX.ScProductPrice, HTMLScProductPriceElement>('sc-product-price');
export const ScProductPriceChoices = /*@__PURE__*/createReactComponent<JSX.ScProductPriceChoices, HTMLScProductPriceChoicesElement>('sc-product-price-choices');
export const ScProductPriceModal = /*@__PURE__*/createReactComponent<JSX.ScProductPriceModal, HTMLScProductPriceModalElement>('sc-product-price-modal');
...
export const ScSubscriptionReactivate = /*@__PURE__*/createReactComponent<JSX.ScSubscriptionReactivate, HTMLScSubscriptionReactivateElement>('sc-subscription-reactivate');
