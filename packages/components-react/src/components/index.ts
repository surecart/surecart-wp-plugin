...
export const ScDonationRecurringChoices = /*@__PURE__*/createReactComponent<JSX.ScDonationRecurringChoices, HTMLScDonationRecurringChoicesElement>('sc-donation-recurring-choices');
