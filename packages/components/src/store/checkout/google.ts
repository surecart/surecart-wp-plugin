 ...
 */
listenAndTrack('scAddedToCart', 'add_to_cart', (e: CustomEvent) => {
 ...
 */
listenAndTrack('scProductRemoved', 'remove_from_cart', (e: CustomEvent) => {
  const item: LineItem = e.detail;
 ...
 */
listenAndTrack('scViewedCart', 'view_cart', (e: CustomEvent) => {
 ...
 */
listenAndTrack('scCheckoutInitiated', 'begin_checkout', (e: CustomEvent) => {
  const checkout: Checkout = e.detail;
 ...
 */
listenAndTrack('scCheckoutCompleted', 'purchase', (e: CustomEvent) => {
  const checkout: Checkout = e.detail;
 ...
 */
listenAndTrack('scPaymentInfoAdded', 'add_payment_info', (e: CustomEvent) => {
 ...
 */
listenAndTrack('scShippingInfoAdded', 'add_shipping_info', (e: CustomEvent) => {
  const checkout: Checkout = e.detail;
