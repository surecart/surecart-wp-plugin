...
| `status`    | `status`    | The tag's statux type.                     | `"fulfilled" \| "on_hold" \| "partially_fulfilled" \| "scheduled" \| "unfulfilled"` | `undefined` |
...
graph TD;
  ...
  style sc-order-fulfillment-badge fill:#f9f,stroke:#333,stroke-width:4px
```
