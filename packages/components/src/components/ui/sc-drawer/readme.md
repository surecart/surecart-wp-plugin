...
| `drawerCloseAnnouncement` | `drawer-close-announcement` |                                                                                                                                                                                                 | `string`                                | `__('Drawer Closed', 'surecart')` |
| `drawerOpenAnnouncement`  | `drawer-open-announcement`  |                                                                                                                                                                                                 | `string`                                | `__('Drawer Opened', 'surecart')` |
