...
import { PrestoDropdown } from '../dropdown';

describe('presto-dropdown', () => {
  function withPanelClass(name) {
    return `
    <presto-dropdown close-on-select="">
      <mock:shadow-root>
      <div class="dropdown">
  ...
  it('renders', async () => {
    const page = await newSpecPage({
      components: [PrestoDropdown],
      html: `<presto-dropdown></presto-dropdown>`,
    });
  ...
  it('can be positioned', async () => {
    ...
    const element = await page.doc.querySelector('presto-dropdown');
