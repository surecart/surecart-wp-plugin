...
export class CERadio {
  ...
  getAllRadios() {
    const radioGroup = this.el.closest('ce-radio-group');
    // Radios must be part of a radio group
    if (!radioGroup) {
      return [];
    }
    return [...radioGroup.querySelectorAll('ce-radio')].filter((radio: HTMLCeRadioElement) => radio.name === this.name) as HTMLCeRadioElement[];
  }

  getSiblingRadios() {
    return this.getAllRadios().filter(radio => radio !== this.el) as HTMLCeRadioElement[];
  }
