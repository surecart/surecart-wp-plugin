...
describe('ce-form-control', () => {
  it('renders', async () => {
    ...
    await page.setContent('<ce-form-control></ce-form-control>');

    const element = await page.find('ce-form-control');
  ...
  it('Can have sizes', async () => {
    ...
    const input = await page.find('ce-form-control >>> .form-control');

    await page.$eval('ce-form-control', (elm: any) => {
      elm.size = 'large';
    });
  ...
  it('Can have a label', async () => {
    ...
    // content
    const label = await page.find('ce-form-control >>> .form-control__label');
  ...
  it('Can have help text', async () => {
    ...
    const help = await page.find('ce-form-control >>> .form-control__help-text');
