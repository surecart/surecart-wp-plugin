...
@Component({
  tag: 'presto-input',
  styleUrl: 'presto-input.scss',
  shadow: true,
})
export class PrestoInput {
  ...
  @Event({ composed: true })
  prestoChange: EventEmitter<void>;

  /** Emitted when the clear button is activated. */
  @Event() prestoClear: EventEmitter<void>;

  /** Emitted when the control receives input. */
  @Event() prestoInput: EventEmitter<void>;
  ...
  render() {
    return (
      <presto-form-control size={this.size} label={this.label} showLabel={this.showLabel} help={this.help} inputId={this.inputId} helpId={this.helpId} labelId={this.labelId}>
        <div
          part="base"
          class={{
            'input': true,
