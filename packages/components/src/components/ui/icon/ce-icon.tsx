...
export class CeIcon {
  ...
  @Event() ceLoad: EventEmitter<void>;

  /** Emitted when the icon failed to load.  */
  @Event() ceError: EventEmitter<{ status: number }>;
      ...
      try {
        ...
        if (url !== this.getUrl()) {
          ...
          if (svgEl) {
            ...
            this.svg = '';
            this.ceError.emit({ status: file.status });
          }
        } else {
          this.svg = '';
          this.ceError.emit({ status: file.status });
