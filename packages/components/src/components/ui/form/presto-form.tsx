...
@Component({
  tag: 'presto-form',
  styleUrl: 'presto-form.scss',
  shadow: true,
})
export class PrestoForm {
   ...
   */
  @Event() prestoSubmit: EventEmitter<{ formData: FormData; formControls: HTMLElement[] }>;
  ...
  async submit() {
    ...
    this.prestoSubmit.emit({ formData, formControls });
