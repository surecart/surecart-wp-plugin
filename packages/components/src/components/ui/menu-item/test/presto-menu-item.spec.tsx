...
import { PrestoMenuItem } from '../presto-menu-item';

describe('presto-menu-item', () => {
  it('renders', async () => {
    const page = await newSpecPage({
      components: [PrestoMenuItem],
      html: `<presto-menu-item></presto-menu-item>`,
    });
  ...
  it('Can be checked', async () => {
    const page = await newSpecPage({
      components: [PrestoMenuItem],
      html: `<presto-menu-item checked></presto-menu-item>`,
    });
    expect(page.root).toEqualHtml(`
      <presto-menu-item checked="">
        <mock:shadow-root>
