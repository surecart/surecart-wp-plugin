<div <?php echo get_block_wrapper_attributes(['class' => 'wp-block-button']); ?>
	<?php echo wp_kses_data( wp_interactivity_data_wp_context( [
		...
		'adHocDialog' => '#ad-hoc-dialog' . $block->context['surecart/product']->id,
	 ] ) ); ?>>
	<a
...
<dialog id='#ad-hoc-dialog-<?php echo esc_attr( $block->context['surecart/product']->id); ?>' class="sc-dialog" data-wp-on--click="surecart/dialog::callbacks.closeOverlay">
