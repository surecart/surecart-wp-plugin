...
class Block extends BaseBlock {
	...
	public function render( $attributes, $content ) {
		...
		<sc-product-buy-button
			...
			<button disabled class="wp-block-button__link sc-block-button__link wp-element-button <?php echo esc_attr( $this->getClasses( $attributes ) ); ?>" style="<?php echo esc_attr( $this->getStyles( $attributes ) ); ?>">
				<span data-text><?php echo esc_html( $attributes['out_of_stock_text'] ?? __( 'Unavailable', 'surecart' ) ); ?></span>
				<?php echo $attributes['add_to_cart'] ? '<sc-spinner data-loader></sc-spinner>' : ''; ?>
			</button>
		</sc-product-buy-button>
