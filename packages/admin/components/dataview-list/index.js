/**
 * DataView List — Reusable components for SureCart admin list pages.
 *
 * Usage:
 *   import { DataViewListLayout, useDataViewState, createListRoot } from '../components/dataview-list';
 */
