			...
			{ hasControls && (
				...
				>
					{ hasTabs ? (
								...
								>
									<a
										...
										css={ css`
											...
											font-size: 14px;
											font-weight: ${ activeTab === tab.value ? '600' : '400' };
											color: ${ activeTab === tab.value ? '#1d2327' : '#646970' };
											border-bottom: ${ activeTab === tab.value
												? '2px solid #1d2327'
						...
						<div /> // spacer when no tabs but headerControls exist
					) }
