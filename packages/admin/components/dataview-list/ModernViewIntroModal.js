	...
	return (
		...
		>
			...
			>
				...
				>
					{__(
						"We've redesigned every data table in SureCart — cleaner layout, noticeably faster performance, and a better experience across the board. Your data stays exactly the same.",
						'surecart'
					)}
				</p>
