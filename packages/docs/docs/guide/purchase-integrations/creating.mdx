...
This can certainly be simplified to be more DRY, which you can see in the full example, below. But it gives You
a basic idea of how to implement the PurchaseSyncInterface.
