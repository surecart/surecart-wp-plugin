...
### Finding CSS Parts
To find the specific css parts available for styling, you can check out our [Components Documentation](./components). Each has a section on "Shadow Parts" to see the available shadow parts for styling.
...
To restyle the input field, we are going to refer to the [input component codex](http://localhost:3000/docs/components/input#component-codex:~:text=on%20the%20input.-,Shadow%20Parts,-Part). This will give us information about the various css parts that can be used for styling.
...
To restyle the customer email field, we are going to refer to the [input component codex](http://localhost:3000/docs/components/input#component-codex:~:text=on%20the%20input.-,Shadow%20Parts,-Part). This will give us information about the various css parts that can be used for styling.
...
To restyle the customer email field, we are going to refer to the [address component codex](http://localhost:3000/docs/components/address#:~:text=reportValidity()%20%3D%3E%20Promise%3Cboolean%3E-,Shadow%20Parts,-Part). This will give us information about the various css parts that can be used for styling.
