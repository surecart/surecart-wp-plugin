...
```html
<presto-input-button></presto-input-button>
```
...
<DemoTabs>
  <DemoTabs.Code>
    {`
<presto-input placeholder="Enter your name"></presto-input>
`}
  </DemoTabs.Code>
  <presto-input placeholder="Enter your name"></presto-input>
</DemoTabs>
...
<DemoTabs>
  <DemoTabs.Code>
    {`
<presto-input placeholder="Clearable" clearable></presto-input>
`}
  </DemoTabs.Code>
  <presto-input placeholder="Clearable" clearable></presto-input>
</DemoTabs>
...
<DemoTabs>
  <DemoTabs.Code>
    {`
<presto-input placeholder="Disabled" disabled></presto-input>
`}
  </DemoTabs.Code>
  <presto-input placeholder="Disabled" disabled></presto-input>
</DemoTabs>
...
<DemoTabs>
  <DemoTabs.Code>
    {`
<presto-input placeholder="Small" size="small"></presto-input>
<presto-input placeholder="Medium" size="medium"></presto-input>
<presto-input placeholder="Large" size="large"></presto-input>
`}
  </DemoTabs.Code>
  <presto-input placeholder="Small" size="small"></presto-input>
  <br />
...
<DemoTabs>
  <DemoTabs.Code>
    {`
<presto-input placeholder="Small" size="small">
    <span slot="prefix">👍🏻</span>
    <span slot="suffix">👍🏻</span>
</presto-input>
<presto-input placeholder="Medium" size="medium">
    <span slot="prefix">👍🏻</span>
    <span slot="suffix">👍🏻</span>
</presto-input>
<presto-input placeholder="Large" size="large">
    <span slot="prefix">👍🏻</span>
    <span slot="suffix">👍🏻</span>
</presto-input>
`}
...
<DemoTabs>
  <DemoTabs.Code>
    {`
<presto-input label="What is your name"></presto-input>
`}
  </DemoTabs.Code>
  <presto-input label="What is your name"></presto-input>
</DemoTabs>
