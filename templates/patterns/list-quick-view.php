 ...
 */
return [
	'title'      => __( 'Product List Quick View', 'surecart' ),
...
<div class="wp-block-group"><!-- wp:surecart/product-sale-badge {"style":{"typography":{"fontSize":"12px"},"border":{"radius":"100px"}}} /--></div>
<!-- /wp:group --></div></div>
<!-- /wp:cover --></div>
<!-- /wp:group -->
