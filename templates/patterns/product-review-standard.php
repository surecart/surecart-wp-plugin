...
return [
	...
	<!-- wp:paragraph {"metadata":{"name":"/ 5.0"},"style":{"typography":{"lineHeight":"1.5","fontSize":"14px"},"color":{"text":"#4b5563"},"elements":{"link":{"color":{"text":"#4b5563"}}},"spacing":{"padding":{"top":"0","bottom":"0"},"margin":{"top":"0","bottom":"0"}}}} -->
	<p class="has-text-color has-link-color" style="color:#4b5563;font-size:14px;line-height:1.5;padding-top:0;padding-bottom:0;margin-top:0;margin-bottom:0">/ 5.0</p>
	<!-- /wp:paragraph --></div>
	<!-- /wp:group -->
