...
return [
	...
	<div class="wp-block-columns"><!-- wp:column {"verticalAlignment":"center","width":"280px"} -->
		<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:280px">
			<!-- wp:group {"style":{"spacing":{"blockGap":"14px"},"layout":{"selfStretch":"fill","flexSize":null}},"layout":{"type":"flex","flexWrap":"nowrap","orientation":"vertical","verticalAlignment":"center"}} -->
			<div class="wp-block-group">
				<!-- wp:group {"style":{"spacing":{"blockGap":"5px"}},"layout":{"type":"flex","flexWrap":"nowrap","verticalAlignment":"bottom"}} -->
				<div class="wp-block-group">
					<!-- wp:surecart/product-review-average-rating-value {"className":"is-style-none","style":{"typography":{"fontStyle":"normal","fontWeight":"600","lineHeight":"1","fontSize":"24px"}}} /-->
		...
		<div class="wp-block-column is-vertically-aligned-center">
			<!-- wp:surecart/product-review-breakdown {"columns":2,"className":"is-style-default","layout":{"type":"flex","justifyContent":"left","orientation":"horizontal","verticalAlignment":"center"}} /-->
		</div>
		<!-- /wp:column -->
	</div>
	<!-- /wp:columns -->
	...
	<!-- wp:group {"metadata":{"name":"Header"},"layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"space-between"}} -->
	<div class="wp-block-group"><!-- wp:surecart/product-review-list-sidebar-toggle {"label":"Filters"} /-->

		<!-- wp:surecart/product-review-add-button {"width":100,"className":"is-style-fill","style":{"elements":{"link":{"color":{"text":"var:preset|color|white"}}},"spacing":{"blockGap":"var:preset|spacing|30"}},"backgroundColor":"surecart","textColor":"white"} /-->
	</div>
	<!-- /wp:group -->

	<!-- wp:group {"layout":{"type":"flex","flexWrap":"nowrap","verticalAlignment":"top"}} -->
	<div class="wp-block-group">
		<!-- wp:surecart/product-review-list-sidebar {"style":{"layout":{"selfStretch":"fixed","flexSize":"280px"},"position":{"type":"sticky","top":"0px"},"spacing":{"blockGap":"30px"}},"layout":{"type":"flex","orientation":"vertical"}} -->
		<div class="wp-block-surecart-product-review-list-sidebar">
			...
			<div class="wp-block-group"
				...
				<div class="wp-block-group sc-review-header-group" style="margin-bottom:16px">
					...
					<div class="wp-block-group">
						...
						<!-- wp:surecart/product-review-verified-badge {"label":"Verified Buyer","style":{"typography":{"fontStyle":"normal","fontWeight":"400","fontSize":"16px"},"spacing":{"blockGap":"var:preset|spacing|30"},"layout":{"selfStretch":"fit","flexSize":null}},"layout":{"type":"flex","justifyContent":"center","verticalAlignment":"center","orientation":"horizontal"}} /-->
					</div>
					<!-- /wp:group -->

					<!-- wp:surecart/product-review-date {"datetime":"2025-10-02T09:37:00.225Z","format":"human-diff","style":{"typography":{"fontSize":"14px"}}} /-->
				</div>
				<!-- /wp:group -->
				...
				<!-- wp:surecart/product-review-content {"style":{"typography":{"fontSize":"16px"}}} /-->
			</div>
			<!-- /wp:group -->
