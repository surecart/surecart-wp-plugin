...
return [
	...
	<div class="wp-block-group" style="padding-right:0px;padding-left:0px;margin-top:0;margin-bottom:0"><!-- wp:paragraph {"metadata":{"name":"Based on"},"style":{"typography":{"fontSize":"14px"},"spacing":{"padding":{"top":"0","bottom":"0"},"margin":{"top":"0","bottom":"0"}}}} -->
	<p style="font-size:14px;padding-top:0;padding-bottom:0;margin-top:0;margin-bottom:0">' . $based_on . '</p>
	<!-- /wp:paragraph -->
