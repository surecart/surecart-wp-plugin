...
return [
	...
	<!-- wp:surecart/subtotal {"className":"ce-subtotal"} -->
	...
	<!-- wp:surecart/total {"className":"ce-line-item-total"} -->
	<sc-line-item-total class="sc-line-item-total" total="total" size="large" show-currency="1" class="wp-block-surecart-total ce-line-item-total"><span slot="description">Total</span><span slot="subscription-title">Total Due Today</span></sc-line-item-total>
